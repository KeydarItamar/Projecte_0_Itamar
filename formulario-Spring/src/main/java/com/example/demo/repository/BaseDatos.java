...
public class BaseDatos {
	...
	ArrayList<Libro> libros = new ArrayList<Libro>();
		...
		libros.add(new Libro(10, "PERSONAJES MITICOS","RICHARD HOLLIGANT", "DEBATE", "7/9/2006 8:00:00","ENTRETENIMIENTO"));
		...
		libros.add(new Libro(18,"NOTICIA DE UN SECUESTRO", "GABRIEL GARCIA GARCIA","ALFAGUARA", "7/12/2005 0:00:00","FICCION"));
